 ...
 */
public class BeerTableModel extends AbstractTableModel {
    ...
    public BeerTableModel(ProjektDataController dataBaseController) {
        this.dataBaseController = dataBaseController;
        beers = new ArrayList<Beer>();
    }

    public BeerTableModel(List<Beer> beers, ProjektDataController dataBaseController) {
        this.dataBaseController = dataBaseController;
        this.beers = beers;
    }
