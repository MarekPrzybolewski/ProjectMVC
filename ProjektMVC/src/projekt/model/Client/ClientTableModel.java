...
public class ClientTableModel extends AbstractTableModel {
    ...
    public ClientTableModel(ProjektDataController dataBaseController){
        this.dataBaseController =dataBaseController;
        clients = new ArrayList<Client>();
    }

    public ClientTableModel(List<Client> clients, ProjektDataController dataBaseController){
        this.dataBaseController =dataBaseController;
    ...
    private boolean checkIsUpdateSure(){
        ...
        dialogResult = JOptionPane.showConfirmDialog(dataBaseController.getBaseController().getAppFrame().getClientPanel(),"Czy chcesz edytować klienta", "Ostrzeżenie",dialogButton);
        if(dialogResult == 0){
            return true;
        }
        else{
