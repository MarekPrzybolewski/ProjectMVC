 ...
 */
public class SearchSellerTableModel extends AbstractTableModel {
    ...
    public SearchSellerTableModel(ProjektDataController dataBaseController) {
        this.dataBaseController = dataBaseController;
        sellers = new ArrayList<Seller>();
    }

    public SearchSellerTableModel(List<Seller> sellers, ProjektDataController dataBaseController) {
        this.dataBaseController = dataBaseController;
            ...
            if (isValueCorrect(value, column)) {
                switch (column) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        seller.setPensja(Double.parseDouble((String)value));
                        break;
                    case 4:
                ...
                JOptionPane.showMessageDialog(new ProjektSellerPanel(new ProjektAppController()), "Zla wartosc");
            }
        }
